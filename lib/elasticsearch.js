...
const $elastic = function(){
    ...
    this.search = (obj) => {
        return new $promise((resolve, reject) => {
            self.client.search(obj).then((res) => resolve(res.body)).catch((err) => reject(self.$$formatError(err)));
        });
    };

    this.bulk = (obj) => {
        return new $promise((resolve, reject) => {
            self.client.bulk(obj).then((res) => resolve(res.body)).catch((err) => reject(self.$$formatError(err)));
        });
    };
