                            ...
                            switch(objArg.sep){
                                ...
                                case '==':
                                    if(aryArgValue.length>1){
                                        ...
                                        aryArgValue.forEach((argValue) => {
                                            ...
                                            objStatement.term[objArgName] = argValue.toLowerCase();
                                            objArgument.bool.must.push(objStatement)
                                        })
                                    }else{
                                        objArgument = {"term" : {}};
                                        objArgument.term[objArgName] = objArgValue.toLowerCase();
                                    }
                                    aryFilter.push(objArgument);
                                    break;
                                case '@>':
                                ...
                                case '!=':
                                    ...
                                    if(aryArgValue.length>1){
                                        ...
                                        let objStatement = {"term" : {}};
                                        objStatement.term[objArgName] = objArgValue.toLowerCase();
                                        objArgument.bool.must_not.push(objStatement)
                                    }
                                    aryFilter.push(objArgument);
                                    break;
                                ...
                                case '%%':
                                    if(aryArgValue.length>1){
                                        ...
                                        aryArgValue.forEach((argValue) => {
                                            ...
                                            objStatement.wildcard[objArgName] = `*${argValue.toLowerCase()}*`;
                                            objArgument.bool.must.push(objStatement)
                                        })
                                    }else{
                                        objArgument = {"wildcard" : {}};
                                        objArgument.wildcard[objArgName] = `*${objArgValue.toLowerCase()}*`;
                                    }
                                    aryFilter.push(objArgument);
                                    break;
                                case '%a':
